...
var LocationApi = function () {
    ...
    _createClass(LocationApi, [{
        ...
        value: function getMyIp() {
            return fetch("https://api.ipify.org?format=json").then(function (resolve) {
        ...
        value: function getMyLocation(myIp) {
            return fetch('https://freegeoip.net/json/' + myIp).then(function (resolve) {
                if (resolve.status === 200) {
                    return resolve.json();
                } else {
                    return Promise.reject(resolve.status);
...
btn2.addEventListener('click', function () {
    ...
    if (inp3.value) {
        dom.showPreloader();
        setTimeout(function () {
            weather.getWeather(inp3.value).then(function (res) {
...
},{"./location_api":6,"./dom":7}],10:[function(require,module,exports) {
...
//# sourceMappingURL=/lesson_22.fdc4664a.map